package ru.dev4rev.zoobukvy.domain.use_case.interactor
...
import ru.dev4rev.zoobukvy.domain.entity.game_state.GameState
...
import ru.dev4rev.zoobukvy.domain.use_case.deal_cards.DealCards
import ru.dev4rev.zoobukvy.domain.use_case.deal_cards.DealCardsImpl
import ru.dev4rev.zoobukvy.domain.use_case.level_and_rating.LevelAndRatingCalculatorImpl
import ru.dev4rev.zoobukvy.domain.use_case.computer.AnimalLettersComputer
import ru.dev4rev.zoobukvy.domain.use_case.computer.animal_letters_computer_simple_smart.AnimalLettersComputerSimpleSmart
import ru.dev4rev.zoobukvy.domain.use_case.deal_players.DealPlayersForGame
import ru.dev4rev.zoobukvy.domain.use_case.deal_players.DealPlayersForGameImpl
import ru.dev4rev.zoobukvy.domain.use_case.level_and_rating.LevelAndRatingCalculator
