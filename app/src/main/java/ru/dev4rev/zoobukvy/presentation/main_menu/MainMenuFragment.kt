package ru.dev4rev.zoobukvy.presentation.main_menu
...
import ru.dev4rev.zoobukvy.appComponent
import ru.dev4rev.zoobukvy.configuration.Conf
import ru.dev4rev.zoobukvy.configuration.Conf.Companion.SPAN_COUNT_AVATARS_RECYCLER_VIEW
import ru.dev4rev.zoobukvy.databinding.FragmentMainMenuBinding
import ru.dev4rev.zoobukvy.domain.entity.player.PlayerInGame
import ru.dev4rev.zoobukvy.domain.entity.card.TypeCards
import ru.dev4rev.zoobukvy.presentation.animal_letters_game.AnimalLettersGameFragment
import ru.dev4rev.zoobukvy.presentation.animal_letters_game.AnimalLettersGameFragment.Companion.TAG_ANIMAL_LETTERS_FRAGMENT
import ru.dev4rev.zoobukvy.presentation.customview.createAlphaShowAnimation
import ru.dev4rev.zoobukvy.presentation.customview.createScaleAnimation
import ru.dev4rev.zoobukvy.presentation.main_menu.RemovePlayerDialogFragment.Companion.TAG_REMOVE_PLAYER_DIALOG_FRAGMENT
import ru.dev4rev.zoobukvy.presentation.main_menu.list_avatars.AvatarsAdapter
import ru.dev4rev.zoobukvy.presentation.main_menu.list_players.adapter.PlayersAdapter
import ru.dev4rev.zoobukvy.presentation.main_menu.list_players.click_listener_owner.AddPlayerClickListenerOwner
import ru.dev4rev.zoobukvy.presentation.main_menu.list_players.click_listener_owner.EditPlayerClickListenerOwner
import ru.dev4rev.zoobukvy.presentation.main_menu.list_players.click_listener_owner.PlayerClickListenerOwner
import ru.dev4rev.zoobukvy.utility.ui.ViewBindingFragment
import ru.dev4rev.zoobukvy.utility.ui.viewModelProviderFactoryOf
