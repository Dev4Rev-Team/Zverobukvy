...
public final class PlayersDatabase_Impl extends PlayersDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `players` (`name` TEXT NOT NULL, `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)");
        _db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_players_name` ON `players` (`name`)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'cf0229d8f6e0f51e6a26f3458b3a7a7a')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsPlayers = new HashMap<String, TableInfo.Column>(2);
        ...
        _indicesPlayers.add(new TableInfo.Index("index_players_name", true, Arrays.asList("name"), Arrays.asList("ASC")));
        ...
        if (! _infoPlayers.equals(_existingPlayers)) {
          return new RoomOpenHelper.ValidationResult(false, "players(ru.gb.zverobukvy.domain.entity.Player).\n"
                  + " Expected:\n" + _infoPlayers + "\n"
                  + " Found:\n" + _existingPlayers);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "cf0229d8f6e0f51e6a26f3458b3a7a7a", "5e095521118997fc0cf58d5b426ff38d");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(PlayersDao.class, PlayersDao_Impl.getRequiredConverters());
  ...
  public PlayersDao playersDao() {
    if (_playersDao != null) {
      ...
      synchronized(this) {
        if(_playersDao == null) {
          _playersDao = new PlayersDao_Impl(this);
        }
        return _playersDao;
      }
    }
